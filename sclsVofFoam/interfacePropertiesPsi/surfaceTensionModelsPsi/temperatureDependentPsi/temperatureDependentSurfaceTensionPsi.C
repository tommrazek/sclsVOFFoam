...
#include "temperatureDependentSurfaceTensionPsi.H"
#include "volFields.H"
...
namespace Foam
{
namespace surfaceTensionModelsPsi
{
    defineTypeNameAndDebug(temperatureDependent, 0);
    addToRunTimeSelectionTable
    (
        surfaceTensionModelPsi,
...
Foam::surfaceTensionModelsPsi::temperatureDependent::temperatureDependent
(
    const dictionary& dict,
    const fvMesh& mesh
)
:
    surfaceTensionModelPsi(mesh),
...
Foam::surfaceTensionModelsPsi::temperatureDependent::sigma() const
{
...
bool Foam::surfaceTensionModelsPsi::temperatureDependent::readDict
(
    const dictionary& dict
)
{
...
bool Foam::surfaceTensionModelsPsi::temperatureDependent::writeData
(
    Ostream& os
) const
{
    if (surfaceTensionModelPsi::writeData(os))
    {
